    ...
    <div ref={containerRef} className="w-full pt-20">
      ...
      >
        ...
        <div className="relative z-10 space-y-3 px-4 max-w-3xl sa-item from-left">
          ...
          Focused training in semiconductor technology, VLSI, and intelligent
          hardware design. Prepares students for cutting-edge roles in chip
          design, electronics innovation, and next-gen semiconductor
          technologies.{" "}
        </div>
      </section>
      ...
      <section className="bg-white flex justify-center px-6 py-16">
        <div className="max-w-6xl  mx-auto flex items-center gap-10 space-y-10">
          <div className="flex-[5] text-center sa-item from-left">
            ...
            <h1 className="text-5xl  text-orange-700">MTECH</h1>
            <div className="w-auto h-6"></div>
        ...
        <div className="max-w-6xl  mx-auto flex flex-col items-center gap-10 space-y-10">
          ...
          <div className="text-center text-white text-lg max-w-4xl">
            <p>
              ...
              perferendis, mollitia fuga placeat repellat quo corporis, ad
              cumque sapiente tempore quam facilis deleniti quae minus vero
              aspernatur. Voluptatem, nobis architecto? Lorem ipsum dolor sit
              amet, consectetur adipisicing elit. Magnam, perferendis, mollitia
              fuga placeat repellat quo corporis, ad cumque sapiente tempore
              quam facilis deleniti quae minus vero aspernatur. Voluptatem,
              nobis architecto?
            </p>
            <div className="w-auto h-6"></div>
          </div>
        ...
        <div className="max-w-6xl  mx-auto flex flex-col items-center gap-4 space-y-10">
          ...
          <div className="flex flex-col gap-4 text-left">
            <ul className="flex flex-col gap-4 text-xl text-orange-700 leading-relaxed list-disc list-outside pl-6 max-w-5xl mx-auto">
              <li>
                Engineers and professionals seeking to accelerate their careers
                in semiconductor technology, chip design,and electronic system
                innovation will benefit from this program.
              </li>
              <li>
                Individuals eager to gain hands-on expertise in VLSI circuit
                development, hardware verification, andintelligent system
                integration for modern industrial applications should apply. 
              </li>
              <li>
                Those interested in working with cutting-edge technologies for
                consumer electronics, automotive,telecommunications, and
                IoT—where advanced semiconductor solutions drive industry
                growth—will find thisprogram highly relevant.
              </li>
              <li>
                Industry practitioners aiming to upskill or transition into
                roles in design automation, embedded systems, orsemiconductor
                manufacturing, as well as those aspiring to lead R&D teams or
                drive innovation in techcompanies, are ideal candidates.{" "}
              </li>
            </ul>
          </div>
          <div className="w-auto h-1"></div>
